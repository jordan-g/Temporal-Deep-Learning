...
parser.add_argument("-feedback_bias",type=float, help="Feedback bias",default=-5)
...
if tmp == "Normal":
	...
	import network30 as net
	net.ref = 30
elif tmp == "network31":
	import network31 as net
	net.ref = 31
elif tmp == "network32":
	import network32 as net
	net.ref = 32
else:
...
net.feedback_bias     = args.feedback_bias 
