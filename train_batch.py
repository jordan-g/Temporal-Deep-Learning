...
parser.add_argument("-Y_range", help="Range of initial feedback weights", type=lambda s: [float(item) for item in s.split(',')], default=[0, 1.0])
parser.add_argument("-f_etas", help="Feedforward learning rates", type=lambda s: [float(item) for item in s.split(',')], default=[0, 0.0001, 0.0001])
